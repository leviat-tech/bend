...
var words = {
  ...
  w: function w(_ref5) {
    ...
    for (var i = instructions.length - 1; i >= 0; i -= 1) {
    ...
    for (var _i = index; _i >= 0; _i -= 1) {
      if (instructions[_i].type === 'barRadius') {
        barR = instructions[_i].radius;
        break;
      }
    }
    ...
    for (var _i2 = index; _i2 >= 0; _i2 -= 1) {
      if (instructions[_i2].type === 'bendRadius') {
        bendR = instructions[_i2].radius + barR;
        break;
      }
    }
    ...
    for (var _i3 = 1; _i3 <= loopCount; _i3++) {
      //  Bend reduces length of segment by tan(w/2) / radius
      var shift = barR !== 0 ? Math.abs(barR * Math.tan((0, _vector.deg2rad)(angleValue / 2))) : 0;
      ...
      if (bendR === 0) {
        ...
        var lengthToTangent = bendR / Math.tan((0, _vector.deg2rad)(180 - Math.abs(angleValue)) / 2);
      ...
      if (loopCount === 2 && _i3 === 1) {
        var radius = bendR - barR;
        instructions.push({
          type: 'bendRadius',
          radius: radius
        });
  ...
  neg: function neg(_ref9) {
    var instructions = _ref9.instructions,
        params = _ref9.params;
    var p = params.pop();
    params.push(-p);
    return {
...
var draw = {
  barRadius: function barRadius(_ref10) {
    var pen = _ref10.pen,
  ...
  bendRadius: function bendRadius(_ref11) {
    var pen = _ref11.pen,
  ...
  forward: function forward(_ref12) {
    var pen = _ref12.pen,
  ...
  rotate: function rotate(_ref15) {
    var pen = _ref15.pen,
        instruction = _ref15.instruction;
    return {
      pen: _objectSpread({}, pen),
      commands: [{
        type: 'rotate',
        params: [],
...
var drawProjected = _objectSpread(_objectSpread({}, draw), {}, {
  forward: function forward(_ref16) {
    var pen = _ref16.pen,
        instruction = _ref16.instruction;
    var position = pen.position.add(pen.direction.scale(instruction.pivotLength));
    return {
      pen: _objectSpread(_objectSpread({}, pen), {}, {
        position: position
      }),
  ...
  rotate: function rotate(_ref18) {
    var pen = _ref18.pen,
        instruction = _ref18.instruction;
    var position = pen.position;
    return {
      pen: _objectSpread({}, pen),
      commands: [{
        type: 'rotate',
...
var cmdPt = function cmdPt(_ref19) {
...
var invertParams = function invertParams(_ref20) {
...
var ptIsOnSegment = function ptIsOnSegment(_ref21, _ref22) {
  ...
  var isOnLine = fuzzyEqual(cross, 0);
...
var instructionsToPath = function instructionsToPath(instructions) {
  var list = instructions.map(function (_ref24) {
...
var verticesToPath = function verticesToPath(vertices) {
  ...
  for (var i = 1; i < vertices.length; i += 1) {
    var vec = (0, _vector["default"])(vertices[i]).subtract(vertices[i - 1]);
    segA = vec.magnitude();
    angleA = vec.angleDeg();
    var angle = i === 1 ? 0 : angleA - angleB;
    shift = d !== 0 ? Math.abs(d / 2 * Math.tan((0, _vector.deg2rad)(angle / 2))) : 0;
    segA += shift;
    segB += shift; // Add preceding straight segment
...
Bend.prototype.projectedCommands = function lengths() {
  ...
  var cmds = [{
    type: 'moveto',
    params: [pen.position.x, pen.position.y, pen.position.z]
  }];
  this.instructions().forEach(function (instruction) {
...
Bend.prototype.segments = function segments() {
  var _ref25 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref25$invertY = _ref25.invertY,
      invertY = _ref25$invertY === void 0 ? false : _ref25$invertY;
...
Bend.prototype.bend = function bend(index, t, angle) {
  var instructions = this.instructionList(); // Find index of instruction to replace
  ...
  var segLength = parseFloat(replacedInstruction.params[0]);
  var l1 = t * segLength;
...
Bend.prototype.reverse = function reverse() {
  ...
  var instructions = this.instructionList().reverse().map(function (_ref27) {
  ...
  var merged = (_ref28 = []).concat.apply(_ref28, _toConsumableArray(ranges));
...
Bend.prototype.print = function print() {
  var _ref29 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref29$invertY = _ref29.invertY,
      invertY = _ref29$invertY === void 0 ? false : _ref29$invertY;
  ...
  return this.commands().map(function (command) {
    ...
    return cmd.type !== 'rotateby' ? [cmds[command.type]].concat(_toConsumableArray(svgParams)).join(' ') : ' ';
  }).join(' ');
};
