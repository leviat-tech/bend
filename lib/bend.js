...
var words = {
  ...
  w: function w(_ref5) {
    ...
    for (var _i2 = 1; _i2 <= loopCount; _i2++) {
  ...
  bb: function bb(_ref6) {
    ...
    for (var _i3 = index; _i3 >= 0; _i3--) {
      if (instructions[_i3].type === 'bendRadius') {
        bendR = instructions[_i3].radius + barR;
        break;
      }
    }
...
var draw = {
  ...
  bendZ: function bendZ(_ref15) {
    var _pen$bendRadius, _pen$barRadius;

    var pen = _ref15.pen,
        instruction = _ref15.instruction;
    var bendR = (_pen$bendRadius = pen.bendRadius) !== null && _pen$bendRadius !== void 0 ? _pen$bendRadius : 0;
    var barR = (_pen$barRadius = pen.barRadius) !== null && _pen$barRadius !== void 0 ? _pen$barRadius : 0;
    var r = bendR + barR;
    var direction = pen.direction.rotateDeg(instruction.angle); // Assuming Z-axis bend rotates in-plane
...
var drawProjected = _objectSpread(_objectSpread({}, draw), {}, {
  forward: function forward(_ref17) {
    var pen = _ref17.pen,
